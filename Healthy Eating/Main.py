...
def draw():
    ...
    if game_over:
        ...
        screen.draw.text("Congrats, you did it!",fontsize=30,color="blue",center=(400,350))
    else:
        for item in items:
            item.draw()
